package de.mineformers.gui.api.component.layout;

import com.google.common.eventbus.Subscribe;
import de.mineformers.gui.api.component.UIComponent;
import de.mineformers.gui.api.component.interaction.UIRadioButton;
import de.mineformers.gui.api.event.MouseClickEvent;
import de.mineformers.gui.api.util.Padding;
...
public class UIRadioButtonGroup extends UILayout<UIRadioButtonGroup.RadioButtonGroupConstraints>
{
    ...
    {
        this.addComponent(new UIRadioButton().init("key", key, "label", label));
    }

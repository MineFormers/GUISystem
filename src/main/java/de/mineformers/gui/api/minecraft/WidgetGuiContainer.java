package de.mineformers.gui.api.minecraft;

import de.mineformers.gui.api.component.container.UIPanel;
import de.mineformers.gui.api.component.inventory.UISlot;
...
public class WidgetGuiContainer extends GuiContainer
{
    ...
    protected void func_146976_a(float var1, int mouseX, int mouseY)
    {
        ...
        panel.setScreenPos(field_147003_i, field_147009_r);
        ...
        if (name != null)
            de.mineformers.gui.api.util.RenderHelper.drawString(name, field_147003_i + 5, field_147009_r + 5, 0x404040, false, 1);
        if (autoDrawSlots)
        {

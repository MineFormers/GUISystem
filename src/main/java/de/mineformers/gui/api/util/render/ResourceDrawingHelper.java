package de.mineformers.gui.api.util.render;
...
public class ResourceDrawingHelper implements IDrawingHelper
{
    ...
    public ResourceDrawingHelper(ResourceLocation resource, int width, int height, float u, float v)
    {
        this(resource, width, height, u, v, u + width, v + height);
    }

    public ResourceDrawingHelper(ResourceLocation resource, int width, int height, float u, float v, float uMax, float vMax)
    {
